...
def geo_code(address):
    ...
    params = {"access_token" : "pk.eyJ1IjoibHVjaWFuYWN0IiwiYSI6ImNrZnB1NzJzZjAyaTAyc213bzQzaW5xM2IifQ.g-6i_62u4jlDiZbf_kP7ew",
             "fuzzyMatch" : "false",
             "types" : "address"
             }
    ...
    final_coordinates = {"longitude": coordinates[0],
